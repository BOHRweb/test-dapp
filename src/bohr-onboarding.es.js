...
var EXTENSION_DOWNLOAD_URL = {
    CHROME: 'https://github.com/BOHRweb/bohr-extension-v2',
    FIREFOX: 'https://github.com/BOHRweb/bohr-extension-v2',
    DEFAULT: 'https://github.com/BOHRweb/bohr-extension-v2',
};
// sessionStorage key
...
var Onboarding = /** @class */ (function () {
    function Onboarding(_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.forwarderOrigin, forwarderOrigin = _c === void 0 ? 'https://bohrweb.org' : _c, _d = _b.forwarderMode, forwarderMode = _d === void 0 ? Onboarding.FORWARDER_MODE.INJECT : _d;
        this.forwarderOrigin = forwarderOrigin;
        this.forwarderMode = forwarderMode;
        this.state = Onboarding.isBoHrInstalled()
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 8];
                    case 2:
                        console.debug('Reloading now to register with BoHr');
                        this.state = ONBOARDING_STATE.RELOADING;
                        location.reload();
                        return [3 /*break*/, 8];
                    case 3:
                        console.debug('Registering with BoHr');
    ...
    /**
     * Starts onboarding by opening the BoHr download page and the Onboarding forwarder
     */
    ...
    /**
     * Checks whether the BoHr extension is installed
     */
    Onboarding.isBoHrInstalled = function () {
